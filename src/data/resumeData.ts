  ...
  highlights: [
    {
      ...
      text: 'Designed and developed responsive user interfaces using React, TypeScript, JavaScript, HTML5, and CSS3 for expense tracking, transaction management, bill splitting, and financial dashboards.',
    },
    {
      icon: 'Server',
      text: 'Developed scalable backend services and RESTful APIs using Node.js/Flask/FastAPI, implementing business logic, data validation, authentication, authorization, and exception handling.',
    },
    {
      icon: 'Database',
      text: 'Designed and integrated PostgreSQL/MongoDB databases, developing data models and optimized queries for users, transactions, expenses, settlements, and financial records.',
    },
    {
      icon: 'ShieldCheck',
      text: 'Implemented unit and integration testing, API validation, error handling, and secure data-processing practices to improve application reliability and maintainability.',
    },
    {
      icon: 'Container',
      text: 'Containerized the application using Docker and implemented Git-based development and CI/CD practices to support automated testing, deployment, and application lifecycle management.',
    },
  ],
} as const;
